import { Attraction, AttractionItem} from '../../components/Attraction/Attraction'


const ourAttractions: AttractionItem[] = [
    {
        title: "Тропа предков",
    ...
    return (
        <section id="attractions" className="block">
            ...
            <div className="block__container">
                {
                    ourAttractions.map((item: AttractionItem, index: number) =>
